<template>
  <div class="in-wrap">
    <el-container class="page-header">
        <el-header>
        <h1>Welcome to Chang Liu LAB</h1>
        </el-header>
    </el-container>

<el-menu  class="el-menu-demo" background-color="#006600" color="#FFFFFF" mode="horizontal" @select="handleSelect">
